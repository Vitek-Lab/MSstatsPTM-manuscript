...
load(file = "shigella_pST_TMTFormat.rda")#shigella_peptide_pST
load(file = "shigella_global_TMTFormat.rda")#shigella_global
...
## Run Models ------------------------------------------------------------------
## Contrast Matrix
comparison <- read.delim("../data/OBJ38812_Macrophages_Shigella_comparisons.txt")
