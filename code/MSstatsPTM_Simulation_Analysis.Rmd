...
load(file = "model_data/ptm_models_sim1.rda")#ptm_models_sim1
load(file = "model_data/adjusted_models_sim1.rda")#adjusted_models_sim1 
load(file = "model_data/ttest_models_sim1.rda")#ttest_sim1
load(file = "model_data/adj_ttest_models_sim1.rda")#adj_ttest_sim1
load(file = "model_data/limma_models_sim1.rda")#limma_results_sim1
load(file = "model_data/adj_limma_models_sim1.rda")#adj_limma_sim1
...
for (i in seq_len(nrow(param_combos))){
  ...
  temp2 <- adj_ttest_sim1[[i]] %>% filter(!grepl("NoChange", ptm) & label %in% conds) %>% rename(log2FC = estimate, Label = label)
  temp2$Model <- "T-test"
  temp3 <- adj_limma_sim1[[i]] %>% filter(!grepl("NoChange", PTM) & Label %in% cond2) %>% rename(log2FC = Log2FC)
  temp3$Model <- "Limma"
...
load(file = "model_data/ptm_models_sim3.rda")#ptm_models_sim1
load(file = "model_data/adjusted_models_sim3.rda")#adjusted_models_sim1 
load(file = "model_data/ttest_models_sim3.rda")#ttest_sim1
load(file = "model_data/adj_ttest_models_sim3.rda")#adj_ttest_sim1
load(file = "model_data/limma_models_sim3.rda")#limma_results_sim1
load(file = "model_data/adj_limma_models_sim3.rda")#adj_limma_sim1
...
for (i in seq_len(nrow(param_combos))){
  ...
  temp1$Model <- "Proposed"
  temp1$log2FC <- temp1$log2FC*-1
  temp2 <- adj_ttest_sim3[[i]] %>% filter(!grepl("NoChange", ptm) & label %in% conds) %>% rename(log2FC = estimate, Label = label)
  temp2$Model <- "T-test"
  temp3 <- adj_limma_sim3[[i]] %>% filter(!grepl("NoChange", PTM) & Label %in% cond2) %>% rename(log2FC = Log2FC)
  temp3$Model <- "Limma"
  temp3$log2FC <- temp3$log2FC*-1
