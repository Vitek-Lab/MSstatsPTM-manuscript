...
unadj_spike_ttest <- ttest_final_model %>% filter(labeling == "heavy" & protadj == "no adjustment")
...
adj_spike_ttest <- ttest_final_model %>% filter(labeling == "heavy" & protadj != "no adjustment")
