...
## Update some naming conventions
plot_df[plot_df$Label == 'mix1-mix2'][['contrast_truth']] <- "LogFC: -1 (mix2-mix1)"
plot_df[plot_df$Label == 'mix1-mix3'][['contrast_truth']] <- "LogFC: 1 (mix3-mix1)"
plot_df[plot_df$Label == 'mix1-mix4'][['contrast_truth']] <- "LogFC: 0 (mix4-mix1)"
plot_df[plot_df$Label == 'mix2-mix3'][['contrast_truth']] <- "LogFC: 2 (mix3-mix2)"
plot_df[plot_df$Label == 'mix2-mix4'][['contrast_truth']] <- "LogFC: 1 (mix4-mix2)"
plot_df[plot_df$Label == 'mix3-mix4'][['contrast_truth']] <- "LogFC: -1 (mix4-mix3)"
plot_df$contrast_truth = factor(plot_df$contrast_truth, levels = 
                                  c("LogFC: -1 (mix2-mix1)",
                                    "LogFC: 1 (mix3-mix1)",
                                    "LogFC: 0 (mix4-mix1)",
...
plot_df[plot_df$labeling == 'light'][['labeling']] <- "Background Peptides"
plot_df[plot_df$labeling == 'heavy'][['labeling']] <- "Spike-in Peptides"
plot_df$trueLog2FC=plot_df$trueLog2FC*-1
plot_df[plot_df$Label == 'mix1-mix2'][['trueLog2FC']] <- plot_df[plot_df$Label == 'mix1-mix2'][['trueLog2FC']]*-1
plot_df[plot_df$Label == 'mix1-mix3'][['trueLog2FC']] <- plot_df[plot_df$Label == 'mix1-mix3'][['trueLog2FC']]*-1
