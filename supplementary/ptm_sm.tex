...
\hline
%%%% colnames of table
&  & \multicolumn{5}{c|}{Experimental design} & Data availability \\
& Dataset & \multirow{2}{*}{Comparison} & No. of & No. of Bio.& No. of Tech.& \multirow{2}{*}{Details in}   & (MassIVE.quant  \\
&  & & Conditions & Replicates & Replicates &  & or R package) \\
\hline
\hline
% &&&&& \\[-0.05in]
%%%% DDA:ControlledMix
\multirow{3}{*}{\rotatebox[origin=c]{90}{Known}}  \multirow{3}{*}{\rotatebox[origin=c]{90}{ Ground}} \multirow{3}{*}{\rotatebox[origin=c]{90}{ Truth}} & DDA:ControlledMix \cite{Chiva2014} & Group & 5 & 1 & 3 & Suppl. Sec. & \\
 &&&&&&& \\[-0.05in]
%\hline 
%&&&&&&&& \\[-0.05in]
% \cline{2-9}
% &&&&&&&& \\[-0.05in]
%%% DDA iPRG2015
& DDA:Choi2017 \cite{Choi:2017jan}  & Group & 4 & 1 & 3 &  & \\
 &&&&&&& \\[-0.05in]
%\hline 
% &&&&&&& \\[-0.05in]
%%% DDA Cox2014
& DDA:Cox2014 \cite{Cox:2014fi} & Group & 2 & 1 & 4 &  & \\
 &&&&&&& \\[-0.05in]
\hline
\multicolumn{8}{c}{ } \\ [0.02in]
\hline 
 &&&&&&& \\[-0.05in]
%%%%%%%%%%%%%%%%%%
%%%% biological study
%%%%%%%%%%%%%%%%%%
%% DDA Meierhofer
\multirow{3}{*}{\rotatebox[origin=c]{90}{Biological}} \multirow{3}{*}{\rotatebox[origin=c]{90}{investigation}} & DDA:Meierhofer2016 \cite{Meierhofer2016} & Paired & 2 & 6 & 2 &  &  \\
&&&&&&& \\[-0.05in]
% \cline{2-9}
% &&&&&&& \\[-0.05in]
%%%% SRM Picotti 2009
& SRM:Picotti2009  \cite{Picotti09} & Time course & 10 & 3 & 1 &  & \\
&&&&&&& \\[-0.05in]
% \cline{2-9}
% &&&&&&& \\[-0.05in]
%%%% SRM Surinova 2015, training
& SRM:Surinova2015:Training \cite{Surinova:2015jn} & Group & 2 & 100 & 1 & &\ [0.02in]
\end{tabular}\\
\end{tiny}
\caption{
}
\label{tab:dataDescriptionSpikein}
\end{table}
