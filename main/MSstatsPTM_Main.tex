...
\noindent {\bf Anova based on modified log$_2$-intensities} 
...
Based on the model, the approach tests the null hypothesis in \eqref{conv_null_hyp}, by comparing the test statistic against the Student distribution with $df=IJK-I$ \todo{should we replace IJK with N (number obs)?} degrees of freedom in balanced designs.
