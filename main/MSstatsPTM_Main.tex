...
\begin{eqnarray}
\widehat{SE}(\Delta)_{adj} = \sqrt{ \widehat{SE}(\hat{\Delta}_{PTM})^{2} + \widehat{SE}(\hat{\Delta}_{protein})^{2}} 
\label{eq:prop_se}
\end{eqnarray}
...
\begin{equation}
\widehat{SE}(\Delta)_{adj}^2 = \left[ \frac{2}{J} \left( \hat{\sigma}_{\gamma^{\ast}}^{2} + \hat{\sigma}_{\gamma}^{2} \right) \right]
...
Details on how the proposed method can be used to run sample size calculations and power analysis on experiments with complex design can be seen in Supplementary Sec. \ref{supp-sec:complex_design}. More details on sample size calculation can be found in~\cite{oberg_vitek_09a}. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{MSstatsPTM corrected for high FDR in computer simulations}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{MSstatsPTM outperformed existing methods in simulations with missing values and low features}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{In a label-free benchmark experiment MSstatsPTM corrected for bias and outperformed existing methods}
...
\subsubsection*{MSstatsPTM removed confounding in two mixture TMT experiment}
...
\subsubsection*{In label-free experiment without a separate global profiling run, MSstatsPTM eliminated the bias due to changes in the unmodified protein, albeit less effectively than in the presence of a global profiling run}
