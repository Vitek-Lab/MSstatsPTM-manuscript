...
\begin{eqnarray}
\Delta_{Protein} = \mu_{i} - \mu_{i^{\prime}}
\end{eqnarray}
...
We separately visualize the PTM and global protein side by side, allowing for easier interpretation and comparison across the datasets. In the modeling stage this is further separated into PTM, global protein, and adjusted PTM visualizations. This allows users to see the affect of the adjustment.
