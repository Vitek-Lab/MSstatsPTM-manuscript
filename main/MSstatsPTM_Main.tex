...
Unfortunately, the $MSstats$ framework focuses on overall protein abundance, and as the result tests the null hypothesis in~\eqref{conv_null_hyp}. It does not account for the confounding between the changes in PTM abundance and the overall changes in protein abundance. This manuscript extends the methodology in $MSstats$ and $MSstatsTMT$, to enable testing of the relevant the null hypothesis in~\eqref{null_hyp}.
