...
\end{eqnarray}
\todo{Is it true that we have a separate variance parameter for each run $ \sigma^2_j$? I don't think so. I think it should be a separate sigma (or maybe $\tau^2$), but same for all the runs}
