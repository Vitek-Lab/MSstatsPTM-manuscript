...
\medskip \noindent {\bf Global Profiling Run:} This experiment included a separate global profiling run \todo{with the same design?} to measure unmodified peptides. There was a 95\% overlap between the identified modified peptides and proteins that were quantified in the global profiling run.
...
\medskip \noindent {\bf Global Profiling Run:} This experiment included a separate global profiling run \todo{with the same design?} to measure unmodified peptides. There was a 90\% overlap between the identified background modified peptides and proteins that were quantified in the global profiling run.
