...
%\def\maria#1{{\color{purple}[For Maria to update: #1]}}
%\def\eduard#1{{\color{OliveGreen}[For Eduard to update: #1]}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Extension to TMT experiment}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Re-analysis of published dataset: TMT experiments}
